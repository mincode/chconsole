...
from main_split.signal_content import SignalContent, TextSignal, HtmlSignal

import qtconsole.qtconsoleapp
import main_split.split_main_window
qtconsole.qtconsoleapp.MainWindow = main_split.split_main_window.MainWindow
