# A new control that includes the qtconsole as a data member
# Too many code modifications required in qtconsole

from modified_qtconsole.jupyter_widget import JupyterWidget
