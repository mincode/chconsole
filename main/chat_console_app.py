...
if os.name == 'nt':
    ...
    try:
        ...
        windll.shell32.SetCurrentProcessExplicitAppUserModelID("Jupyter.cconsole")
...
_examples = """
jupyter cconsole                      # start the chat console
"""
...
class ChatConsoleApp(JupyterApp, JupyterConsoleApp):
    ...
    def init_qt_app(self):
        ...
        self.app = QtGui.QApplication(['jupyter-cconsole'])
        self.app.setApplicationName('jupyter-cconsole')
