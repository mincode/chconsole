...
def process_command_meta(chat_instruction, chat_secret, client_id, username):
    """
    Create importable object for the command.
    :param chat_instruction: meta command dict.
    :param chat_secret: secret of the chat_instruction.
